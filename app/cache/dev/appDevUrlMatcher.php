...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // switchlocale
        if (0 === strpos($pathinfo, '/locale') && preg_match('#^/locale/(?P<locale>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'switchlocale')), array (  '_controller' => 'Walva\\HafBundle\\Controller\\PublicArticleController::switchlocaleAction',));
        }
